...
namespace CamelsClub.API.Controllers.UserManagment
{
    ...
    public class UserAccountController : BaseController
    {
        ...
        public ResultViewModel<ConfirmationMessageViewModel> Login(LoginCreateViewModel viewModel)
       {
        ...
        [HttpGet]
        [AuthorizeUserFilter(Role = "User")]
        [Route("api/User/GetAvailableRefereesList")]
        public ResultViewModel<PagingViewModel<UserSearchViewModel>> GetAvailableRefereesList(int competitionID, string text = "", string orderBy = "ID", bool isAscending = false, int pageIndex = 1, int pageSize = 20)
        {
            ResultViewModel<PagingViewModel<UserSearchViewModel>> resultViewModel = new ResultViewModel<PagingViewModel<UserSearchViewModel>>();
            var userID = int.Parse(UserID);
            resultViewModel.Data = _userService.FindAvailableUsersToBeReferees(competitionID,userID, text, orderBy, isAscending, pageIndex, pageSize, Language);
            resultViewModel.Success = true;
            resultViewModel.Message = Resource.DataLoaded;
            return resultViewModel;
        }
        ...
        [HttpGet]
        [AuthorizeUserFilter(Role = "User")]
        [Route("api/User/GetAvailableCheckersList")]
        public ResultViewModel<PagingViewModel<UserSearchViewModel>> GetAvailableCheckersList(int competitionID, string text = "", string orderBy = "ID", bool isAscending = false, int pageIndex = 1, int pageSize = 20)
        {
            ResultViewModel<PagingViewModel<UserSearchViewModel>> resultViewModel = new ResultViewModel<PagingViewModel<UserSearchViewModel>>();
            var userID = int.Parse(UserID);
            resultViewModel.Data = _userService.FindAvailableUsersToBeCheckers(competitionID,userID, text, orderBy, isAscending, pageIndex, pageSize, Language);
            resultViewModel.Success = true;
            resultViewModel.Message = Resource.DataLoaded;
            return resultViewModel;
        }
