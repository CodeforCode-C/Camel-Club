...
namespace CamelsClub.API.Controllers.Comment
{
    public class GroupController : BaseController
    {
        ...
        [HttpGet]
        [AuthorizeUserFilter(Role = "User")]
        [Route("api/Group/FilterCamels")]
        public ResultViewModel<List<CamelViewModel>> FilterCamels(int groupID, string CamelName)
        {
            try
            {
                ResultViewModel<List<CamelViewModel>> resultViewModel = new ResultViewModel<List<CamelViewModel>>();
                resultViewModel.Data = _groupService.FilterCamels(groupID, CamelName);
                resultViewModel.Success = true;
                resultViewModel.Message = Resource.DataLoaded;
                return resultViewModel;
