...
namespace CamelsClub.API.Controllers
{
    public class CompetitionCheckerController : BaseController
    {
        ...
        [HttpPost]
        [AuthorizeUserFilter(Role = "User")]
        [Route("api/Checker/Replace")]
        public ResultViewModel<bool> ReplaceChecker(CheckerReplaceCreateViewModel viewModel)
        {
            try
            {
                viewModel.UserID = int.Parse(UserID);
                return new ResultViewModel<bool>(_CompetitionCheckerService.ReplaceChecker(viewModel), Resource.UpdatedSuccessfully, true);
        ...
        [HttpPost]
        [AuthorizeUserFilter(Role = "User")]
        [Route("api/Checker/ReplaceCamel")]
        public ResultViewModel<bool> ReplaceCamel(ReplaceCamelRequestCreateViewModel viewModel)
        {
            try
            {
                
                viewModel.UserID = int.Parse(UserID);
                return new ResultViewModel<bool>(_CompetitionCheckerService.ReplaceCamel(viewModel), Resource.UpdatedSuccessfully, true);
        ...
        [HttpGet]
        [AuthorizeUserFilter(Role = "User")]
        [Route("api/Checker/ApproveReplacedCamel")]
        public ResultViewModel<bool> ApproveReplacedCamel(int ID)
        {
            try
            {
                int loggedUserID = int.Parse(UserID);
                return new ResultViewModel<bool>(_CompetitionCheckerService.ApproveReplacedCamel(loggedUserID, ID), Resource.UpdatedSuccessfully, true);
            }
            catch (Exception ex)
            {
                return new ResultViewModel<bool>(ex.Message);
        ...
        public ResultViewModel<ApproveGroupResultViewModel> ApproveGroup(ApproveGroupCreateViewModel viewModel)
        {
            try
            {
                viewModel.UserID = int.Parse(UserID);
                return new ResultViewModel<ApproveGroupResultViewModel>(_CompetitionCheckerService.ApproveGroup(viewModel), Resource.AddedSuccessfully, true);

            }
            catch (Exception ex)
            {
                return new ResultViewModel<ApproveGroupResultViewModel>(ex.Message);
        ...
        [HttpPost]
        [AuthorizeUserFilter(Role = "User")]
        [Route("api/Checker/AddNewMembers")]
        public ResultViewModel<bool> AddNewMembers(List<CompetitionCheckerPickupViewModel> viewModels)
        {
            try
            {
                var loggedUserID = int.Parse(UserID);
                return new ResultViewModel<bool>(_CompetitionCheckerService.AddNewCheckersToTeam(viewModels, loggedUserID), Resource.DataLoaded, true);
