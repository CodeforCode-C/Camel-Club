...
namespace CamelsClub.Services
{
    public class DashboardService : IDashboardService
    {
        ...
        public DashboardViewModel GetDashboardData(string orderBy = "ID", bool isAscending = false, int pageIndex = 1, int pageSize = 20)
        {
            ...
            latestCompetitionsResult = competitions.ToList();
            //latest users
            ...
            //.Skip(excludedRows).Take(pageSize)
            latestUsersResult = users.ToList();
            // get user statictics
            ...
            var finalResult = new DashboardViewModel
            {
                ...
                CompetitionsCount = latestCompetitionsResult.Count(),
    ...
    public class DashboardViewModel
    {
        ...
        public int CompetitionsCount { get; internal set; }
    }
