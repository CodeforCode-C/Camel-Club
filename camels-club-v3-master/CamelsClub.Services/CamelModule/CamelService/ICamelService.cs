...
namespace CamelsClub.Services
{
    ...
    {
        PagingViewModel<CamelViewModel> Search(int userID, int categoryId = 0, string name="", string orderBy = "ID", bool isAscending = false, int pageIndex = 1, int pageSize = 20, Languages language = Languages.Arabic);
