...
namespace CamelsClub.Services
{
    public interface INotificationService
    {
        ...
        void AddNotification(NotificationCreateViewModel notification);
        void AddNotifications(List<NotificationCreateViewModel> notifications);
       ...
       void SendNotifictionForUser(NotificationCreateViewModel notifucation);
        ...
        void SendNotifictionForUserWithoutCallingDB(NotificationCreateViewModel notifucation);
