...
namespace CamelsClub.Services
{
    public interface ICamelCompetitionService
    {
        ...
        bool HasCamelsToReplace(int loggedUserID, int competitionID);
        List<CamelViewModel> GetAvailableCamels(int loggedUserID);
        ...
        List<UserCamelCompetitionViewModel> GetCompetitorCamels(int loggedUserID, int competitionID);
        bool ReplaceCamel(ReplaceCamelCompetitionCreateViewModel viewModel);
    }
}
