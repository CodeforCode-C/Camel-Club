...
namespace CamelsClub.Services
{
    public interface ICompetitionRefereeService
    {
        ...
        FinalCamelReportViewModel GetCamelReport(int ID, int loggedUserID);
        bool AddNewMembers(List<CompetitionCheckerPickupViewModel> viewModels, int loggedUserID);

        GroupReportViewModel GetGroupReport(int groupID, int competitionID, int loggedUserID);
        List<GroupReportViewModel> GetCompetitionReport(int competitionID, int loggedUserID);
        ...
        List<SpecificationValueViewModel> GetCamelSpecificationValues(int userID, int camelCompetitionID);
