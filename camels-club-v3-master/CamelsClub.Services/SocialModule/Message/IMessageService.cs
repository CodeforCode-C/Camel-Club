...
namespace CamelsClub.Services
{
    public interface IMessageService
    {
        ...
        bool SendImage(ImageMessageCreateViewModel viewModel);
        bool SendVideo(VideoMessageCreateViewModel viewModel);
        bool SendImages(ImagesMessageCreateViewModel viewModel);
    }
}
