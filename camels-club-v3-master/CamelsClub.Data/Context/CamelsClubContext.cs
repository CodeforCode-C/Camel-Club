...
namespace CamelsClub.Data.Context
{
    public class CamelsClubContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new CompetitionGeneralConditionConfiguration());
            modelBuilder.Configurations.Add(new SharedPostConfiguration());
            modelBuilder.Configurations.Add(new UserCamelSpecificationReviewConfiguration());
        ...
        public virtual DbSet<CompetitionGeneralCondition> CompetitionGeneralConditions { get; set; }
        public virtual DbSet<SharedPost> SharedPosts { get; set; }
        public virtual DbSet<UserCamelSpecificationReview> UserCamelSpecificationReviews { get; set; }
